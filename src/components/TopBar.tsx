      ...
      <div className="topbar-actions">
        ...
        {activeProject && (
          <button
            ...
            title="Carica il server MCP di ruflo in questa sessione per lo swarm di sub-agenti — costa token API a consumo oltre all'abbonamento OAuth quando esegue agenti"
          >
            Ruflo
          </button>
        )}
